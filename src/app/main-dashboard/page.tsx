...
const POSITION_ACCESS: Record<Position, string[]> = {
    ...
    "SCM Staff": ["scm", "mfg", "cafeteria"], // ✅ added
    "Finance Staff": ["finance", "cafeteria"], // ✅ added
    "HR Staff": ["hr", "cafeteria"], // ✅ added
    "Sales/CRM Staff": ["crm", "comms", "cafeteria"], // ✅ added
    Auditor: ["arf", "finance", "cafeteria"], // ✅ added
    PMO: ["pm", "pm-monitoring", "cafeteria"], // ✅ added
};
...
const SUBSYSTEMS: SubsystemItem[] = [
    ...
    // ✅ NEW: Cafeteria (NO URL as requested)
    {
        id: "cafeteria",
        title: "Cafeteria",
        subtitle: "Daily menu, meal subsidies, transactions, and employee dining services",
        href: "/cafeteria",
        status: "active",
        ...
        tag: "CAF",
        accentClass:
            "bg-lime-500/10 text-lime-700 dark:text-lime-300 ring-1 ring-lime-500/20",
        submodules: [
            { id: "menu", title: "Menu", status: "comingSoon" },
            { id: "orders", title: "Orders", status: "comingSoon" },
            { id: "payments", title: "Payments", status: "comingSoon" },
            { id: "subsidy", title: "Subsidy", status: "comingSoon" },
        ],
    },
